...
@bp.route('/department/<int:dept_id>/export-data')
@login_required
@super_admin_required
def export_department_data(dept_id):
    """Return all application data for a department as JSON (for client-side Excel generation)"""
    from flask import jsonify
